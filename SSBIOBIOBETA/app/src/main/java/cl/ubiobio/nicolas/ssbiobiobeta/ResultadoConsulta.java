            ...
            switch (name) {
                ...
                case ETIQUETA_DESCRIPCION:
                    ...
                    if (descripcion_codigo!=null&& descripcion_codigo!=""){
                        descodigo.setText("Descripcion: "+ descripcion_codigo.toUpperCase() );
                    }else {
                        descodigo.setText("Descripción: NO HAY DATOS" );
                    }
                    break;
                case ETIQUETA_PACIENTE:
                    paciente = leerPaciente(parser);
                    if(paciente!=null&& paciente!="") {
                        pacien.setText("Nombre Paciente: " + paciente.toUpperCase());
                    }else{
                ...
                case ETIQUETA_FECHA_ASIGNADA:
                    ...
                    if (fecha_asignada!=null&& fecha_asignada!="") {
                        fechaAsing.setText("Fecha Asignada: " + fecha_asignada.toUpperCase());
                    }else {
                ...
                case ETIQUETA_PROFESIONAL:
                    ...
                    if(profesional!=null && profesional!="") {
                        profes.setText("Profesional: " + profesional.toUpperCase());
                    }{
                ...
                case ETIQUETA_POLICLINICO:
                    ...
                    if (policlinico!=null&& policlinico!="") {
                        polici.setText("Policlinico: " + policlinico.toUpperCase());
                    }else{
                ...
                case ETIQUETA_UBICACION:
                    ...
                    if(ubicacion!=null&&ubicacion!=""){
                        ubic.setText("Ubicacion: "+ ubicacion.toUpperCase() );
                    }else{
