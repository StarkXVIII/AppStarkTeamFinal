...
public class AtencionCerrada extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        consulta7=(TextView) findViewById(R.id.consulta7);
        ...
        findViewById(R.id.consultaboton7).setOnClickListener(this);
    }
        ...
        switch (view.getId()) {
            case R.id.consultaboton:
                if(consulta.getVisibility() == View.GONE)
                {
                    ...
                    consulta7.setVisibility(View.GONE);
                }else
                {
            ...
            case R.id.consultaboton6:
                ...
                break;
            case R.id.consultaboton7:
                if(consulta7.getVisibility() == View.GONE)
                {
                    consulta7.setVisibility(View.VISIBLE);
                    consulta.setVisibility(View.GONE);
                    consulta2.setVisibility(View.GONE);
                    consulta3.setVisibility(View.GONE);
                    consulta4.setVisibility(View.GONE);
