...
public class MapsActivityTodas extends AppCompatActivity implements LocationSource, OnMapReadyCallback,
    ...
    /*private LatLng locationFarmacia;*/
    ...
    private ArrayList<LatLng> direcciones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_todas);
        /*Intent data = getIntent();
        if(data.getExtras() != null){
            Log.d("data","latitud: " + data.getExtras().getDouble("latitud"));
            locationFarmacia = new LatLng(data.getExtras().getDouble("latitud"), data.getExtras().getDouble("longitud"));
        }*/
        nombres = new ArrayList<>();
        farmaciasDeTurno = new ArrayList<>();
        farmaciasDeTurno=BotonFarmaciaTurno.farmaciasDeTurno;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (int i = 0; i <farmaciasDeTurno.size() ; i++) {
                direcciones.add(new LatLng(farmaciasDeTurno.get(i).getLatitud(), farmaciasDeTurno.get(i).getLongitud()));
                nombres.add(farmaciasDeTurno.get(i).getNombre_farmacia());
        }
        ...
        if(direcciones.size()!=0){
            ...
            for (int i = 0; i <direcciones.size() ; i++) {
                ...
                markerOptions.position(direcciones.get(i));
                markerOptions.title(nombres.get(i));
                mMap.animateCamera(CameraUpdateFactory.newLatLng(direcciones.get(i)));
                mMap.moveCamera(CameraUpdateFactory.newLatLng(direcciones.get(i)));
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, UPDATE_INTERVAL_IN_MILLISECONDS, 10, new android.location.LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    if(MapsActivityTodas.this.listener != null){
                        MapsActivityTodas.this.listener.onLocationChanged(location);
                    }
                }
