        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(sharedPre.getInt("MODO", NO_PREFERENCES) == NO_PREFERENCES){
                    ...
                    alertBuilder.setMessage(Html.fromHtml("<font color='#000000'>Elija el modo de interfaz</font>"))
                            .setTitle(Html.fromHtml("<font color='#000000'>Servicio de Salud Bio-Bío</font>"))
