...
public class MapsActivityCentrosTodos extends AppCompatActivity implements LocationSource, OnMapReadyCallback,
    ...
    private ArrayList<CentroSalud> centrosDeSalud;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_centros_todos);

        nombres = new ArrayList<>();
        centrosDeSalud = new ArrayList<>();
        centrosDeSalud=BotonCentroSalud.centrosDeSalud;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (int i = 0; i <centrosDeSalud.size() ; i++) {
            direcciones.add(new LatLng(centrosDeSalud.get(i).getLatitud(), centrosDeSalud.get(i).getLongitud()));
            nombres.add(centrosDeSalud.get(i).getNombre());
        }
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, UPDATE_INTERVAL_IN_MILLISECONDS, 10, new android.location.LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    if(MapsActivityCentrosTodos.this.listener != null){
                        MapsActivityCentrosTodos.this.listener.onLocationChanged(location);
                    }
                }
