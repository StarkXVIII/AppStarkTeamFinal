    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Uri uri = Uri.parse("geo:"+farmacia.getLatitud()+","+farmacia.getLongitud()+"?z=16&q="+farmacia.getLatitud()+","+farmacia.getLongitud());
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("latitud",farmacia.getLatitud());
                intent.putExtra("longitud",farmacia.getLongitud());
                intent.putExtra("nombre", farmacia.getNombre_farmacia());
