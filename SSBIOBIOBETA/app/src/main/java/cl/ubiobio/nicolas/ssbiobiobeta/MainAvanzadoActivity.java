...
public class MainAvanzadoActivity extends AppCompatActivity
    ...
    * para mostrarlos en la pantalla base*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * de mostrarlo*/
        ...
        FloatingActionButton btn = ( FloatingActionButton) findViewById(R.id.recargar);
        ...
        if(isConnected(MainAvanzadoActivity.this)){
            ...
            alertBuilder.setMessage(Html.fromHtml("<font color='#000000'>Para usar algunas funciones de la aplicación, necesitas estar conectado a internet.</font>"))
                    ...
                    .setNegativeButton("AUDIO", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            mp = MediaPlayer.create(MainAvanzadoActivity.this, R.raw.voz_mensaje);
                            mp.start();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent iniciar = null;
            AlertDialog.Builder alertBuilder = new AlertDialog.Builder(_this);
            alertBuilder.setMessage(Html.fromHtml("<font color='#000000'>¿Está Seguro?</font>"))
                    .setTitle(Html.fromHtml("<font color='#000000'>Cambiar a Modo Normal</font>"))
    ...
    * y redirige a la clase correspondiente al momento de seleccionar alguna opción de los botones*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.botonOcho) {
            Intent intent = new Intent(MainAvanzadoActivity.this,BotonCentroSalud.class);
            intent.putExtra("info","Click en salud responde");
            startActivity(intent);
