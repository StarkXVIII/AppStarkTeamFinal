...
public class MapsActivityCentros extends AppCompatActivity implements LocationSource, OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_centros);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        enableMyLocation();
        if(locationFarmacia != null){
            MarkerOptions markerOptions = new MarkerOptions();
            markerOptions.position(locationFarmacia);
            markerOptions.title("Centro de Salud");
            mMap.clear();
            mMap.animateCamera(CameraUpdateFactory.newLatLng(locationFarmacia));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(locationFarmacia));
            mMap.animateCamera(CameraUpdateFactory.zoomTo(12));
            mMap.addMarker(markerOptions);

        }

        FloatingActionButton btn = (FloatingActionButton) findViewById(R.id.mostrartodas);
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), MapsActivityCentrosTodos.class);
                startActivity(intent);
            }
        });
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, UPDATE_INTERVAL_IN_MILLISECONDS, 10, new android.location.LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    if(MapsActivityCentros.this.listener != null){
                        MapsActivityCentros.this.listener.onLocationChanged(location);
                    }
                }
