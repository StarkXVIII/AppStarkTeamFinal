...
public class MapsActivityDonar extends AppCompatActivity implements LocationSource, OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationDonar = new LatLng(Double.parseDouble(latitud), Double.parseDouble(longitud));
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       // mMap.setOnMapLongClickListener(this); //click largo en el mapa
        ...
        enableMyLocation();
        if(locationDonar != null){
            MarkerOptions markerOptions = new MarkerOptions();
            markerOptions.position(locationDonar);
            markerOptions.title("Complejo Asistencial Dr. Victor Ríos Ruiz");
            mMap.clear();
            mMap.animateCamera(CameraUpdateFactory.newLatLng(locationDonar));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(locationDonar));
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, UPDATE_INTERVAL_IN_MILLISECONDS, 10, new android.location.LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    if(MapsActivityDonar.this.listener != null){
                        MapsActivityDonar.this.listener.onLocationChanged(location);
                    }
                }
